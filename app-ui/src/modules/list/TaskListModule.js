...
export const initialState = {
  data: [
    {id:1,title:'Racing car',desc:'Racing car sprays burning fuel into crowd.',type:'ticket',actions:[{name:'Acknowledge'},{name:'Done'},{name:'OpenTicketDetail'}]},
    {id:2,title:'Japanese princess',desc:'Japanese princess to wed commoner.',type:'ticket',actions:[{name:'Acknowledge'},{name:'Done'},{name:'OpenTicketDetail'}]},
